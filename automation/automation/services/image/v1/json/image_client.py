...
from automation.common import glance_http
from automation.common import service_client
from automation.common.utils import misc as misc_utils
...
class ImageClient(service_client.ServiceClient):
    ...
    def create_image(self, name, container_format, disk_format,
                     size=None, **kwargs):
        params = {
            "name": name,
    ...
    def update_image(self, image_id, name=None, container_format=None,
                     data=None, properties=None, size=None):
        params = {}
        headers = {}
        if name is not None:
            params['name'] = name
